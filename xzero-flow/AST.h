...
// }}}
// {{{ Symbols
class FLOW_API Symbol : public ASTNode {
 public:
...
class FLOW_API ScopedSymbol : public Symbol {
 protected:
...
class FLOW_API Variable : public Symbol {
 private:
...
class FLOW_API Handler : public Callable {
 private:
  std::unique_ptr<SymbolTable> scope_;
...
class FLOW_API Unit : public ScopedSymbol {
 private:
...
// }}}
// {{{ Expr
class FLOW_API Expr : public ASTNode {
 protected:
...
class FLOW_API ArrayExpr : public Expr {
 private:
...
template <typename T>
class FLOW_API LiteralExpr : public Expr {
 private:
  T value_;
 ...
 * @see ParamList
 */
class FLOW_API CallExpr : public Expr {
 private:
  Callable* callee_;
  ParamList args_;
...
class FLOW_API VariableExpr : public Expr {
 private:
  Variable* variable_;
...
class FLOW_API HandlerRefExpr : public Expr {
 private:
  Handler* handler_;
...
// }}}
// {{{ Stmt
class FLOW_API Stmt : public ASTNode {
 protected:
  explicit Stmt(const FlowLocation& loc) : ASTNode(loc) {}
};

class FLOW_API ExprStmt : public Stmt {
 private:
...
class FLOW_API CompoundStmt : public Stmt {
 private:
...
class FLOW_API AssignStmt : public Stmt {
 private:
  Variable* variable_;
...
class FLOW_API CondStmt : public Stmt {
 private:
...
class FLOW_API MatchStmt : public Stmt {
 public:
