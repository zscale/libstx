...
class FLOW_API NopInstr : public Instr {
 public:
 ...
 */
class FLOW_API AllocaInstr : public Instr {
 private:
...
class FLOW_API StoreInstr : public Instr {
 public:
...
class FLOW_API LoadInstr : public Instr {
 public:
...
class FLOW_API CallInstr : public Instr {
 private:
...
class FLOW_API HandlerCallInstr : public Instr {
 private:
...
class FLOW_API CastInstr : public Instr {
 public:
...
class FLOW_API UnaryInstr : public Instr {
 public:
...
class FLOW_API BinaryInstr : public Instr {
 public:
 ...
 */
class FLOW_API PhiNode : public Instr {
 public:
...
class FLOW_API TerminateInstr : public Instr {
 protected:
 ...
 */
class FLOW_API CondBrInstr : public TerminateInstr {
 public:
  /**
 ...
 */
class FLOW_API BrInstr : public TerminateInstr {
 public:
 ...
 */
class FLOW_API RetInstr : public TerminateInstr {
 public:
 ...
 */
class FLOW_API MatchInstr : public TerminateInstr {
 private:
